...
public class Product {
	...
	public Product(Long id, String title, String description, int price, int discountedPrice, int discount_persent,
	...
	public int getDiscount_persent() {
		return discount_persent;
	}

	public void setDiscount_persent(int discount_persent) {
		this.discount_persent = discount_persent;
	}
